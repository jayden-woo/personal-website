...
export default function About() {
  return (
    <section id={CONTENT_SECTIONS.About} className="mb-30 scroll-mt-16">
      <TagWrapper className="my-4" before="<h2>" after="</h2>" data-observe>
      ...
      <TagWrapper className="my-4 leading-relaxed" before="<p>" after="</p>" data-observe>
        <p className="my-2">
        ...
        <p className="my-2">
          {/* TODO: Add free time hobbies section */}
