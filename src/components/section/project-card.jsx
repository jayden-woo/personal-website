  ...
  return (
    <div className="group flex flex-col">
      <Image
        ...
        className="pointer-events-none origin-left select-none rounded-md border-2 border-gray-500/20 duration-200 group-hover:border-gray-400/40 md:w-9/12 lg:w-10/12 lg:motion-safe:transition lg:motion-safe:group-hover:rotate-2 lg:motion-safe:group-hover:scale-105"
      ...
      <div className="relative -top-6 -mb-4 self-end md:-top-16 md:-mb-14 md:w-10/12">
        <div className="my-2 origin-bottom-right rounded-b-md border-2 border-gray-500/20 bg-gray-870 p-3 shadow-lg shadow-gray-900/40 duration-300 group-hover:border-gray-400/40 md:rounded-md lg:motion-safe:transition lg:motion-safe:group-hover:scale-105">
